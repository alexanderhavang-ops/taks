...
(function () {
  ...
  const DICTS = {
    en: {
      ...
      "import.how_it_works": "Import users from Excel or CSV",
      "import.how_it_works_body": "Upload a participant list, preview how columns map to TAKS user fields, validate the result, then create an import job.",
      "import.step1": "Step 1 — Choose file",
      "import.step2": "Step 2 — Preview and validate",
      "import.selected": "Selected file",
      "import.sample_rows": "Sample rows",
      "import.field_help_title": "Fields this importer understands",
      "import.field_help_required": "Required: username or email. If username is missing, TAKS derives it from the email local-part, e.g. alexander@example.com → alexander.",
      "import.field_help_note": "Headers are matched case-insensitively and normalized. Example: Email, e-mail, mail and Attendee email all map to email.",
      ...
      "import.preview_ok": "Preview looks good. Continue with validation before creating an import job.",
      "import.preview_not_ok": "Preview needs attention. Missing required fields",
      "import.mapping": "Column mapping",
      "import.sample_users": "Sample users",
      "import.raw_preview": "Raw preview",
      "import.result": "Result",
      "import.run_preview_first": "Run preview first.",
      "import.col_idx": "#",
      "import.header": "Header",
      "import.header_norm": "Normalized header",
    ...
    sv: {
      ...
      "nav.ai": "AI",
      "nav.ai3": "AI3",
      "nav.ai_sections": "AI per sektion",
      ...
      "page.onboarding_import": "Onboarding — Importera användare",

      "import.how_it_works": "Importera användare från Excel eller CSV",
      "import.how_it_works_body": "Ladda upp en deltagarlista, förhandsgranska hur kolumnerna mappas till TAKS-användare, validera resultatet och skapa sedan ett importjobb.",
      "import.step1": "Steg 1 — Välj fil",
      "import.step2": "Steg 2 — Förhandsgranska och validera",
      "import.selected": "Vald fil",
      "import.sample_rows": "Exempelrader",
      "import.preview": "Förhandsgranska",
      "import.validate": "Validera",
      "import.jobs": "Importjobb",
      "import.working": "Arbetar…",
      "import.update_existing": "Uppdatera befintliga användare",
      "import.error": "Importfel",
      "import.preview_ok": "Förhandsgranskningen ser bra ut. Fortsätt med validering innan du skapar importjobb.",
      "import.preview_not_ok": "Förhandsgranskningen behöver åtgärdas. Saknar obligatoriska fält",
      "import.mapping": "Kolumnmappning",
      "import.sample_users": "Exempelanvändare",
      "import.raw_preview": "Rå förhandsgranskning",
      "import.result": "Resultat",
      "import.run_preview_first": "Kör förhandsgranskning först.",
      "import.col_idx": "#",
      "import.header": "Rubrik",
      "import.header_norm": "Normaliserad rubrik",
      "import.maps_to": "Mappas till",
      "import.row": "Rad",
      "import.username": "Användarnamn",
      "import.password": "Lösenord",
      "import.is_admin": "Admin",
      "import.groups": "Grupper",
